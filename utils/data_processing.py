...
def get_data_no_label(dataset_name, different_new_nodes_between_val_and_test=False, randomize_features=False,
    ...
    if data_type == None:
        ...
        # edge_features = np.load('./processed_data/ml_{}.npy'.format(dataset_name))
    ...
    val_data = Data_no_label(sources[val_mask], destinations[val_mask], timestamps[val_mask],
                             edge_idxs[val_mask])

    test_data = Data_no_label(sources[test_mask], destinations[test_mask], timestamps[test_mask],
                              edge_idxs[test_mask])

    # validation and test with edges that at least has one new node (not in training set)
    new_node_val_data = Data_no_label(sources[new_node_val_mask], destinations[new_node_val_mask],
                                      timestamps[new_node_val_mask], edge_idxs[new_node_val_mask])

    new_node_test_data = Data_no_label(sources[new_node_test_mask], destinations[new_node_test_mask],
